  ...
  const testimonials = [
    {
      ...
      image: "/arjun.jpg", // replace with actual image path
    },
    {
      quote:
      ...
      image: "/ruchi.jpg", // replace with actual image path
    },
  ];
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
        {testimonials.map((t, idx) => (
          <div key={idx} className="text-left">
            <p className="text-gray-600 italic relative mb-6">
              <span className="text-5xl text-gray-300 absolute -top-4 -left-3">
                “
              </span>
              {t.quote}
              <span className="text-5xl text-gray-300 absolute -bottom-8 -right-3">
                ”
              </span>
            </p>
